...
function CartPanel({
  ...
  return (
    <div className="flex flex-col bg-surface min-h-full">
      ...
      {/* Controls + Summary */}
      {cartItems.length > 0 && (
        <div className="border-t border-line-soft px-4 py-3 space-y-2 bg-surface">
          <textarea
  ...
  return (
    <div className="h-full flex flex-col lg:flex-row overflow-hidden bg-canvas">
      ...
      <div className="lg:hidden flex-shrink-0">
        ...
        {mobileCartOpen && (
          <div className="fixed inset-x-0 bottom-0 top-[57px] z-50 bg-surface shadow-lg overflow-y-auto">
      ...
      {/* Desktop cart panel */}
      <div ref={desktopCartRef} className="hidden lg:block w-80 xl:w-96 border-l border-line overflow-y-auto">
        <CartPanel {...cartPanelProps} />
      </div>

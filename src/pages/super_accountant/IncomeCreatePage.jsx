// src/pages/super_accountant/IncomeCreatePage.jsx
...
export default function IncomeCreatePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast(e?.response?.data?.message || 'Lỗi khi tạo phiếu thu', 'error');
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-[#8E8878]">Phiếu thu sẽ được gửi lên ADMIN/OWNER để duyệt</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
        ...
        <div className="xl:col-span-2 bg-white rounded-2xl border border-black/5 shadow-sm p-5 space-y-4">
          ...
          <button onClick={handleSubmit} disabled={submitting}
            ...
            {submitting ? 'Đang gửi...' : 'Gửi phiếu thu'}
          </button>
        </div>

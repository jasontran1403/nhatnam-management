// src/components/superaccountant/SuperAccountantLayout.jsx
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-white text-xs font-semibold truncate">
                {user?.fullName || user?.username || 'Super Kế toán'}
              </p>
              <p className="text-[#8E8878] text-xs truncate">Kế toán trưởng</p>
            </div>
          </div>
        </div>

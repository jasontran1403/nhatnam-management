...
import { Bell, X, Check, CheckCheck, Clock, Package, CreditCard, Truck, FileText, Factory, ClipboardList, CalendarRange } from 'lucide-react';
...
const EVENT_ICONS = {
  ...
  PRODUCTION_PLAN_CREATED: CalendarRange,
